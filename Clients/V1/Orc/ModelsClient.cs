...
namespace Daisi.SDK.Clients.V1.Orc
{
    ...
    public partial class ModelsClient : ModelsProto.ModelsProtoClient
    {
        private ModelsClient(GrpcChannel orcChannel, IClientKeyProvider clientKeyProvider)
        ...
        internal ModelsClient(string orcDomainOrIp, int orcPort, IClientKeyProvider clientKeyProvider)
